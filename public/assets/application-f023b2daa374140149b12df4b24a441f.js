...
(function() {
  jQuery(function() {
    ...
    dispatcher.on_open = function(data) {
      ...
      return dispatcher.trigger('new_message', {
        msg_body: 'hello what is up!'
      });
    };
    return dispatcher.bind('new_message', function(message) {
      return console.log("new message: " + message.msg_body + ", " + message.user_name + ", " + message.received);
    });
  });
